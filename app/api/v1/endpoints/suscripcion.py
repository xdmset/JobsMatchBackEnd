...
def read_suscripciones_by_usuario(usuario_id: int, db: Session = Depends(get_db)):
...
def read_suscripcion(suscripcion_id: int, db: Session = Depends(get_db)):
...
def create_new_suscripcion(suscripcion: SuscripcionCreate, db: Session = Depends(get_db)):
...
def delete_existing_suscripcion(suscripcion_id: int, db: Session = Depends(get_db)):
