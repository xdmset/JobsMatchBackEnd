...
INSERT INTO `interacciones_swipe` VALUES (1,1,1,1,'2026-02-09 19:07:39','2026-04-03 21:02:54');
/*!40000 ALTER TABLE `interacciones_swipe` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `interacciones_swipe_empresa`
--
...
--
-- Dumping data for table `interacciones_swipe_empresa`
--

LOCK TABLES `interacciones_swipe_empresa` WRITE;
/*!40000 ALTER TABLE `interacciones_swipe_empresa` DISABLE KEYS */;
INSERT INTO `interacciones_swipe_empresa` VALUES (1,2,1,1,1,'2026-02-09 19:07:48','2026-04-03 21:02:54');
/*!40000 ALTER TABLE `interacciones_swipe_empresa` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `matches` VALUES (1,1,1,'2026-02-09 19:07:48');
...
INSERT INTO `perfiles_empresas` VALUES (2,'Tech Solutions','Tecnologia','Empresa de desarrollo de software','https://techsolutions.example','Tijuana, BC',NULL,NULL),(13,'Norte Digital','Tecnologia','Consultoria de software','https://nortedigital.example','Tijuana, BC',NULL,NULL),(14,'Baja Logistics','Logistica','Servicios de logistica regional','https://bajalogistics.example','Mexicali, BC',NULL,NULL),(15,'AgroData','Agroindustria','Analitica para agricultura','https://agrodata.example','Ensenada, BC',NULL,NULL),(16,'HealthSoft','Salud','Software clinico','https://healthsoft.example','Tijuana, BC',NULL,NULL),(17,'FinCore','Finanzas','Plataforma de pagos','https://fincore.example','Tijuana, BC',NULL,NULL),(18,'Oceanic Labs','Investigacion','I+D marino','https://oceaniclabs.example','Ensenada, BC',NULL,NULL),(19,'RetailNova','Retail','Ecommerce regional','https://retailnova.example','Mexicali, BC',NULL,NULL),(20,'EduNext','Educacion','Plataforma edtech','https://edunext.example','Tijuana, BC',NULL,NULL),(21,'GreenGrid','Energia','Soluciones renovables','https://greengrid.example','Rosarito, BC',NULL,NULL);
...
CREATE TABLE `perfiles_estudiantes` (
  ...
  CONSTRAINT `perfiles_estudiantes_chk_1` CHECK (json_valid(`habilidades`))
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `perfiles_estudiantes` VALUES (1,'Leonel Test','UTT','TSU','Desarrollador Backend Jr.','{\"python\": \"avanzado\", \"fastapi\": \"intermedio\"}',NULL,NULL,NULL,NULL,NULL,'Tijuana','remoto',NULL),(4,'Maria Lopez','UABC','Licenciatura','Estudiante de sistemas','{\"java\": \"intermedio\"}',NULL,NULL,NULL,NULL,NULL,'Mexicali','presencial',NULL),(5,'Carlos Ruiz','ITT','Ingenieria','Apasionado por datos','{\"sql\": \"intermedio\", \"python\": \"basico\"}',NULL,NULL,NULL,NULL,NULL,'Tijuana','hibrido',NULL),(6,'Ana Perez','UPBC','TSU','Frontend trainee','{\"react\": \"basico\", \"css\": \"intermedio\"}',NULL,NULL,NULL,NULL,NULL,'Ensenada','remoto',NULL),(7,'Luis Gomez','UABC','Licenciatura','QA junior','{\"testing\": \"intermedio\"}',NULL,NULL,NULL,NULL,NULL,'Tijuana','presencial',NULL),(8,'Sofia Diaz','CETYS','Ingenieria','Mobile dev','{\"kotlin\": \"basico\"}',NULL,NULL,NULL,NULL,NULL,'Mexicali','hibrido',NULL),(9,'Diego Torres','UTT','TSU','Backend trainee','{\"node\": \"basico\", \"express\": \"basico\"}',NULL,NULL,NULL,NULL,NULL,'Tijuana','remoto',NULL),(10,'Valeria Mora','UABC','Licenciatura','UX/UI junior','{\"figma\": \"intermedio\"}',NULL,NULL,NULL,NULL,NULL,'Ensenada','presencial',NULL),(11,'Jorge Neri','ITT','Ingenieria','DevOps junior','{\"linux\": \"intermedio\", \"docker\": \"basico\"}',NULL,NULL,NULL,NULL,NULL,'Tijuana','hibrido',NULL),(12,'Fernanda Cruz','UPBC','TSU','Data analyst','{\"excel\": \"avanzado\", \"powerbi\": \"basico\"}',NULL,NULL,NULL,NULL,NULL,'Mexicali','remoto',NULL);
...
CREATE TABLE `planes` (
  ...
  UNIQUE KEY `ix_planes_paypal_plan_id` (`paypal_plan_id`),
  KEY `ix_planes_id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `postulaciones` (
  ...
  KEY `fk_post_vacante` (`vacante_id`),
...
INSERT INTO `postulaciones` VALUES (1,1,1,1,2,'app_swipe','enviado','2026-02-09 19:07:48','2026-02-09 19:07:48');
...
CREATE TABLE `roles` (
  ...
  KEY `ix_roles_id` (`id`),
  CONSTRAINT `nombre_rol` CHECK ((`nombre` in (_utf8mb4'admin',_utf8mb4'estudiante',_utf8mb4'empresa')))
...
INSERT INTO `roles` VALUES (1,'admin'),(3,'empresa'),(2,'estudiante');
...
INSERT INTO `suscripciones` VALUES (1,1,'free','2026-02-09',NULL,'manual',NULL,NULL,NULL,NULL,NULL,NULL,'estudiante','free_estudiante'),(2,2,'premium','2026-02-09',NULL,'manual',NULL,NULL,NULL,NULL,NULL,NULL,'empresa','premium_empresa'),(3,3,'premium','2026-02-10',NULL,'manual',NULL,NULL,NULL,NULL,NULL,NULL,'estudiante','premium_estudiante');
...
INSERT INTO `usuarios` VALUES (1,2,'estudiante@test.com','$argon2id$v=19$m=65536,t=3,p=4$hHBu7f3few8h5FzLea8VAg$ZbazLyDANyDJ5S2m6tHnx2oKzsbXrfOgkrH43mxdjXg',1,0,1,0,'2026-02-09 19:05:06',NULL),(2,3,'empresa@test.com','$argon2id$v=19$m=65536,t=3,p=4$v7f2ntM655wzprSWUorR+g$QKibglY6fWSxq7Iv4hDq40NFMdieQb9S+Z2O1QibuyM',1,0,1,1,'2026-02-09 19:06:34',NULL),(3,1,'admin@test.com','$argon2id$v=19$m=65536,t=3,p=4$RyhFyPm/lzLGuBcCgBACg
test.com','$argon2id$v=19$m=65536,t=3,p=4$v7f2ntM655wzprSWUorR+g$QKibglY6fWSxq7Iv4hDq40NFMdieQb9S+Z2O1QibuyM',1,0,1,0,'2026-02-10 15:01:00',NULL),(15,3,'empresa4@test.com','$argon2id$v=19$m=65536,t=3,p=4$v7f2ntM655wzprSWUorR+g$QKibglY6fWSxq7Iv4hDq40NFMdieQb9S+Z2O1QibuyM',1,0,1,0,'2026-02-10 15:02:00',NULL),(16,3,'empresa5@test.com','$argon2id$v=19$m=65536,t=3,p=4$v7f2ntM655wzprSWUorR+g$QKibglY6fWSxq7Iv4hDq40NFMdieQb9S+Z2O1QibuyM',1,0,1,0,'2026-02-10 15:03:00',NULL),(17,3,'empresa6@test.com','$argon2id$v=19$m=65536,t=3,p=4$v7f2ntM655wzprSWUorR+g$QKibglY6fWSxq7Iv4hDq40NFMdieQb9S+Z2O1QibuyM',1,0,1,0,'2026-02-10 15:04:00',NULL),(18,3,'empresa7@test.com','$argon2id$v=19$m=65536,t=3,p=4$v7f2ntM655wzprSWUorR+g$QKibglY6fWSxq7Iv4hDq40NFMdieQb9S+Z2O1QibuyM',1,0,1,0,'2026-02-10 15:05:00',NULL),(19,3,'empresa8@test.com','$argon2id$v=19$m=65536,t=3,p=4$v7f2ntM655wzprSWUorR+g$QKibglY6fWSxq7Iv4hDq40NFMdieQb9S+Z2O1QibuyM',1,0,1,0,'2026-02-10 15:06:00',NULL),(20,3,'empresa9@test.com','$argon2id$v=19$m=65536,t=3,p=4$v7f2ntM655wzprSWUorR+g$QKibglY6fWSxq7Iv4hDq40NFMdieQb9S+Z2O1QibuyM',1,0,1,0,'2026-02-10 15:07:00',NULL),(21,3,'empresa10@test.com','$argon2id$v=19$m=65536,t=3,p=4$v7f2ntM655wzprSWUorR+g$QKibglY6fWSxq7Iv4hDq40NFMdieQb9S+Z2O1QibuyM',1,0,1,0,'2026-02-10 15:08:00',NULL);
...
INSERT INTO `vacantes` VALUES (1,2,'Backend Developer Python','Desarrollo de APIs con FastAPI','Conocimientos en SQL y Python',NULL,'remoto','Tijuana, BC',15000.00,20000.00,'MXN','activa','2026-02-09 19:07:31'),(2,2,'Frontend Developer React','Desarrollo de interfaces web','React y CSS avanzado',NULL,'hibrido','Tijuana, BC',12000.00,18000.00,'MXN','activa','2026-02-09 19:07:31');
/*!40000 ALTER TABLE `vacantes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vacantes_visualizaciones`
--
...
--
-- Dumping data for table `vacantes_visualizaciones`
--

LOCK TABLES `vacantes_visualizaciones` WRITE;
/*!40000 ALTER TABLE `vacantes_visualizaciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `vacantes_visualizaciones` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-04-15  8:43:56
